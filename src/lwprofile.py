...
class StatsHolderNameBase:
    def __init__(self, entity: threading.Thread, name: str, parent: 'StatsHolderNameBase'):
        self._entity = entity
        self._name = name
        self._parent = parent


class StatsHolderThreadName(StatsHolderNameBase):
    pass


class StatsHolderProcessName(StatsHolderNameBase):
    pass
...
class StatsHolder:  # pylint: disable=too-few-public-methods
    ...
    def __init__(self, stats: pstats.Stats, path=None, children: List['StatsHolder']=None):
    ...
    def merge_children(self):
        ...
        for child in self._children:
            stats.append(child.stats)
        self.stats.load_stats(*self._children)
        return True
